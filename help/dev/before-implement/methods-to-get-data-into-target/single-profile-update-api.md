...
title: Come posso inserire dati in [!DNL Target] utilizzando [!UICONTROL l'API di aggiornamento a profilo singolo]?
...
# [!UICONTROL Aggiornamento singolo profilo API]
...
Contrasta l&#39;[!UICONTROL API di aggiornamento profilo singolo] con [[!DNL Adobe Target Single Profile Update API]](/help/dev/administer/profile-api/profile-single-api.md).
