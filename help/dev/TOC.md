...
+ Implementazione lato client {#client-side}
   ...
   + Implementazione di Adobe Experience Platform Web SDK {#aep}
      ...
      + [Accedere ai token di risposta](/help/dev/implement/client-side/aep-web-sdk/accessing-response-tokens.md)
      + [usa mbox3rdPartyId](/help/dev/implement/client-side/aep-web-sdk/using-mbox-3rdpartyid.md)
      + [Confrontare la libreria at.js con Platform Web SDK](/help/dev/implement/client-side/aep-web-sdk/web-sdk-atjs-comparison.md)
...
+ Analytics for Target (A4T) con Experience Platform SDK {#a4t}
   + [Registrazione di Adobe Analytics for Target (A4T) in Experience Platform Web SDK](/help/dev/implement/a4t/overview-a4t.md)
