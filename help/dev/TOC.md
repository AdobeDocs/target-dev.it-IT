...
+ Implementazione lato client {#client-side}
   ...
   + Implementazione di Adobe Experience Platform Web SDK {#aep}
      ...
      + [Utilizzare Adobe Target e Platform Web SDK per la personalizzazione](/help/dev/implement/client-side/aep-web-sdk/target-overview.md)
      + [Implementazione di un&#39;applicazione a pagina singola](/help/dev/implement/client-side/aep-web-sdk/spa-implementation.md)
      + [Accesso ai token di risposta](/help/dev/implement/client-side/aep-web-sdk/accessing-response-tokens.md)
      + [Utilizzo dell’ID di terze parti mbox](/help/dev/implement/client-side/aep-web-sdk/using-mbox-3rdpartyid.md)
      + [Confronto della libreria at.js con Web SDK](/help/dev/implement/client-side/aep-web-sdk/web-sdk-atjs-comparison.md)
   + Funzionamento di at.js {#at-js}
      + [Panoramica della libreria JavaScript at.js](/help/dev/implement/client-side/atjs/how-atjs-works/overview.md)
      + [Panoramica sul funzionamento di at.js](/help/dev/implement/client-side/atjs/how-atjs-works/how-atjs-works.md)
      ...
      + [Integrazioni at.js](/help/dev/implement/client-side/atjs/how-atjs-works/target-atjs-integrations.md)
