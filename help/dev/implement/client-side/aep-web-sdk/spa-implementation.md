...
* Una riga di codice singola e una configurazione per sviluppatori una tantum consentono agli addetti al marketing di creare ed eseguire [!UICONTROL test A/B] e [!UICONTROL attività Targeting esperienza] (XT) tramite il [!UICONTROL Compositore esperienza visivo] (VEC) nell&#39;applicazione a pagina singola.

## Visualizzazioni XDM e applicazioni a pagina singola

Il Compositore esperienza visivo di [!UICONTROL Adobe Target] per applicazioni a pagina singola sfrutta un concetto denominato [!UICONTROL Visualizzazioni]: un gruppo logico di elementi visivi che insieme formano un&#39;esperienza di applicazione a pagina singola. Un’applicazione a pagina singola può, pertanto, essere considerata come transizione attraverso le viste, anziché gli URL, in base alle interazioni dell’utente. In genere, una [!UICONTROL visualizzazione] può rappresentare un intero sito o elementi visivi raggruppati all&#39;interno di un sito.

Per ulteriori informazioni sulle visualizzazioni, nell&#39;esempio seguente viene utilizzato un ipotetico sito di e-commerce online implementato in [!DNL React] per esplorare l&#39;esempio [!UICONTROL Visualizzazioni].

Dopo aver visitato la home page, un’immagine protagonista promuove una vendita di Pasqua e gli ultimi prodotti disponibili sul sito. In questo caso, è possibile definire una [!UICONTROL visualizzazione] per l&#39;intera schermata iniziale. Questa [!UICONTROL visualizzazione] può essere chiamata semplicemente &quot;home&quot;.
...
Quando il cliente diventa più interessato ai prodotti venduti dall&#39;azienda, decide di fare clic sul collegamento **Prodotti**. Analogamente alla home page, l&#39;intero sito prodotti può essere definito come [!UICONTROL Visualizzazione]. Questa [!UICONTROL visualizzazione] potrebbe essere denominata &quot;products-all&quot;.
...
Poiché una [!UICONTROL visualizzazione] può essere definita come un intero sito o un gruppo di elementi visivi in un sito. I quattro prodotti visualizzati nel sito prodotti possono essere raggruppati e considerati come [!UICONTROL Visualizzazione]. Questa visualizzazione potrebbe essere denominata &quot;products&quot; (prodotti).
...
Quando il cliente decide di fare clic sul pulsante **Carica altro** per esplorare altri prodotti sul sito, in questo caso l&#39;URL del sito Web non cambia. Tuttavia, è possibile creare una [!UICONTROL visualizzazione] qui per rappresentare solo la seconda riga di prodotti visualizzati. Il nome [!UICONTROL View] potrebbe essere &quot;products-page-2&quot;.
...
Il cliente decide di acquistare alcuni prodotti dal sito e procede alla schermata di pagamento. Sul sito di pagamento, al cliente vengono offerte le opzioni per scegliere la consegna normale o express. Una [!UICONTROL visualizzazione] può essere qualsiasi gruppo di elementi visivi in un sito, quindi è possibile creare una [!UICONTROL visualizzazione] per le preferenze di consegna e chiamarla &quot;Preferenze di consegna&quot;.
...
Il concetto di [!UICONTROL visualizzazioni] può essere esteso molto oltre questo scenario. Questi scenari sono solo alcuni esempi di [!UICONTROL visualizzazioni] che possono essere definite in un sito.

## Implementazione di [!UICONTROL visualizzazioni XDM]
...
>[!NOTE]
>
>Nella prima chiamata `sendEvent()`, tutte le [!UICONTROL visualizzazioni XDM] di cui eseguire il rendering per l&#39;utente finale vengono recuperate e memorizzate nella cache. Le `sendEvent()` chiamate successive con [!UICONTROL Viste XDM] passate vengono lette dalla cache e sottoposte a rendering senza una chiamata al server.
...
Per personalizzare il contenuto sul sito a seconda della preferenza di consegna selezionata, è possibile creare una [!UICONTROL Visualizzazione] per ogni preferenza di consegna. Quando è selezionata l&#39;opzione **Consegna normale**, è possibile denominare [!UICONTROL Visualizzazione] &quot;Checkout-normal&quot;. Se è selezionata l&#39;opzione **Consegna express**, [!UICONTROL Visualizzazione] può essere denominata &quot;checkout-express&quot;.
...
## Utilizzo di [!UICONTROL Compositore esperienza visivo] per un&#39;applicazione a pagina singola

Dopo aver definito le [!UICONTROL visualizzazioni XDM] e implementato `sendEvent()` con le [!UICONTROL visualizzazioni XDM] passate, il Compositore esperienza visivo è in grado di rilevare queste [!UICONTROL visualizzazioni] e consentire agli utenti di creare azioni e modifiche per le attività A/B o XT.
...
Il pannello [!UICONTROL Modifiche] acquisisce le azioni create per una particolare [!UICONTROL Visualizzazione]. Tutte le azioni per una [!UICONTROL Visualizzazione] sono raggruppate in tale [!UICONTROL Visualizzazione].

### Azioni

Facendo clic su un’azione viene evidenziato l’elemento del sito in cui questa viene applicata. Ogni azione del Compositore esperienza visivo creata in una [!UICONTROL Visualizzazione] presenta le icone seguenti: **Informazioni**, **Modifica**, **Clone**, **Sposta** e **Elimina**. Queste icone sono spiegate più dettagliatamente nella tabella seguente.

| Icona | Descrizione |
|---|---|
| Informazioni | Visualizza i dettagli dell’azione. |
| Modifica | Ti consente di modificare direttamente le proprietà dell’azione. |
| Clona | Clona l&#39;azione in una o più [!UICONTROL Viste] presenti nel pannello [!UICONTROL Modifiche] o in una o più [!UICONTROL Viste] a cui sei passato nel Compositore esperienza visivo. L&#39;azione non deve necessariamente essere presente nel pannello [!UICONTROL Modifiche].<br/><br/>**Nota:** Dopo un&#39;operazione di clonazione, è necessario passare alla [!UICONTROL Visualizzazione] nel Compositore esperienza visivo tramite [!UICONTROL Sfoglia] per verificare se l&#39;azione clonata è un&#39;operazione valida. Se non è possibile applicare l&#39;azione alla [!UICONTROL Visualizzazione], verrà visualizzato un errore. |
| Sposta | Sposta l&#39;azione in un [!UICONTROL evento di caricamento pagina] o in qualsiasi altro [!UICONTROL visualizzazione] già esistente nel pannello [!UICONTROL Modifiche].<br/><br/>**Evento di caricamento pagina:** Tutte le azioni corrispondenti all&#39;evento di caricamento pagina vengono applicate al caricamento iniziale della pagina dell&#39;applicazione Web. <br/><br/>**Nota:** dopo un&#39;operazione di spostamento, passa alla [!UICONTROL visualizzazione] nel Compositore esperienza visivo tramite [!UICONTROL Sfoglia] per verificare se lo spostamento è un&#39;operazione valida. Se l&#39;azione non può essere applicata alla [!UICONTROL visualizzazione], viene visualizzato un errore. |
| Elimina | Elimina l’azione. |

## Esempi di utilizzo del Compositore esperienza visivo per le applicazioni a pagina singola

Questa sezione descrive tre esempi per utilizzare il [!UICONTROL Compositore esperienza visivo] per creare azioni e modifiche per le attività A/B o XT.

### Esempio 1: aggiornare la vista &quot;home&quot;

In precedenza in questo articolo era stata definita una [!UICONTROL visualizzazione] denominata &quot;home&quot; per l&#39;intero sito principale. Ora il team marketing desidera aggiornare la visualizzazione &quot;home&quot; nei seguenti modi:
...
Per la [!UICONTROL Visualizzazione] di &quot;products-page-2&quot;, il team marketing desidera modificare l&#39;etichetta **Prezzo** in **Prezzo di vendita** e cambiare il colore dell&#39;etichetta in rosso.
...
[!UICONTROL Le visualizzazioni] possono essere definite a un livello granulare, ad esempio uno stato o un&#39;opzione da un pulsante di opzione. In precedenza in questo articolo [!UICONTROL Le visualizzazioni] erano definite per le preferenze di consegna, &quot;checkout-normal&quot; e &quot;checkout-express&quot;. Il team marketing desidera cambiare il colore del pulsante in rosso per la visualizzazione &quot;checkout-express&quot;.
...
>[!NOTE]
>
>Il pannello [!UICONTROL Visualizzazione] di checkout-express non viene visualizzato nel pannello [!UICONTROL Modifiche] finché non viene selezionato il pulsante di opzione **Consegna express**. Questo perché la funzione `sendEvent()` viene eseguita quando viene selezionato il pulsante di opzione **Consegna express**, pertanto il Compositore esperienza visivo non è a conoscenza del [!UICONTROL Visualizza] di checkout express finché il pulsante di opzione non viene selezionato.
