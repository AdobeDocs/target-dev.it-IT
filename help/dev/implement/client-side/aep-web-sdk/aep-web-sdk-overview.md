...
* Per informazioni complete: [Informazioni su [!UICONTROL Adobe Experience Platform Web SDK]](https://experienceleague.adobe.com/docs/experience-platform/edge/home.html?lang=it)
...
Oltre alla documentazione di [!UICONTROL Platform Web SDK] di cui sopra, negli argomenti di questa guida sono incluse anche informazioni specifiche di [!UICONTROL Platform Web SDK] relative alle funzionalità di [!DNL Target].
