...
description: Utilizza eventi personalizzati per [!DNL Adobe Target] Libreria JavaScript at.js da notificare quando una richiesta o un’offerta mbox ha esito negativo o positivo.
...
Storicamente, mbox.js (ora obsoleto) non consentiva ad altri codici JavaScript in esecuzione sulla pagina di sapere cosa succede dietro le quinte. Con l&#39;avanzamento di at.js, abbiamo avuto un&#39;occasione unica per risolvere questo problema.
...
Guarda il video seguente e scopri come utilizzare i token di risposta e gli eventi personalizzati at.js per condividere le informazioni del profilo da [!DNL Target] a sistemi di terze parti.
