...
description: Utilizza [!UICONTROL adobe.target.sendNotifications()] per at.js per inviare notifiche al  [!DNL Target] edge quando viene eseguito il rendering di un'esperienza che non utilizza [!UICONTROL applyOffer]. (at.js.2.1 +)
