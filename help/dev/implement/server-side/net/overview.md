---
title: Introduzione a  [!DNL Adobe Target] .NET SDK
...
In questa guida di riferimento viene illustrato come i clienti di [!DNL Adobe Target] possono installare, inizializzare e utilizzare .NET SDK.
...
Per informazioni su come iniziare a utilizzare .NET SDK, passare alla [[!DNL Target] Guida introduttiva di SDK](../sdk-guides/getting-started/getting-started.md).
