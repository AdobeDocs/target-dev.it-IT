...
1. Sia il client che `organizationId` possono essere recuperati da [!DNL Adobe Target]passando a **[!UICONTROL Amministrazione]** > **[!UICONTROL Implementazione]**, come illustrato di seguito.
