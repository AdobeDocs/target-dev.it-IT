...
Per accedere al **[!UICONTROL Recommendations Settings]** , aprire Target in [!DNL Adobe Experience Cloud], quindi fai clic su **[!UICONTROL Recommendations]** > **[!UICONTROL Settings]**.

![Pagina Impostazioni Recommendations](/help/dev/implement/recommendations/assets/recs_settings.png)

Sono disponibili le seguenti opzioni:

| Impostazione | Descrizione |
|--- |--- |
| Mbox globale personalizzata | (Facoltativo) Specifica la mbox globale personalizzata utilizzata per le attività di [!UICONTROL Target]. Per impostazione predefinita, la mbox globale utilizzata da [!UICONTROL Target] viene utilizzato per [!UICONTROL Recommendations].<P>Nota: questa opzione è impostata su [!UICONTROL Target] **[!UICONTROL Administration]** pagina. Apri [!UICONTROL Target], quindi fai clic su **[!UICONTROL Administration]** > **[!UICONTROL Visual Experience Composer]**. |
...
| [!UICONTROL Recommendations] Token API | Usa questo token in [!UICONTROL Recommendations] Chiamate API, come API di download. |
